...
![](附件/Pasted%20image%2020260625105048.png)
设置好工作空间，它就不会乱在别的文件夹写入文件。
下载comfyui桌面客户端，
设置comfyui的启动参数
![](附件/bandicam%202026-06-25%2017-56-09-165.mp4)
![](附件/Pasted%20image%2020260625183139.png)
![](附件/Pasted%20image%2020260625184011.png)
工作流导入了之后，记住自己命名的工作流，在Hermes直接通过自然语言即可调用，输入结构为工作流名称+提示词。等待Hermes跑完即可得到图片

---

comfyui工作流选择对显卡要求低的，显存4G就下载模型体积小于4G的模型。